...
PROFILE_CATEGORY_BY_NAME = {
    ...
    "regression-suite-offline": "source_audit",
    "team-observe-offline": "source_audit",
    "p0-safety-boundary": "cleanup_audit",
    "release-cleanup-offline": "cleanup_audit",
    "ui-viewports": "test",
}
...
def command_run_evidence(args: argparse.Namespace) -> None:
    ...
    profiles: Dict[str, Dict[str, Any]] = {
        ...
        "regression-suite-offline": {
            "category": "source_audit",
            "cwd": ROOT,
            "commands": [[sys.executable, str(ROOT / "scripts" / "audit_regression_suite_offline.py")]],
            "artifacts": [],
        },
        ...
        "release-cleanup-offline": {
            "category": "cleanup_audit",
            "cwd": ROOT,
            "commands": [[sys.executable, str(ROOT / "scripts" / "audit_release_cleanup.py")]],
            "artifacts": [],
        },
        "ui-viewports": {
            "category": "test",
